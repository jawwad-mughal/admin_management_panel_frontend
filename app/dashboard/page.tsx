...
export default function DashboardPage() {
  ...
  // Redirect non-admins
  useEffect(() => {
    if (!roleLoading && !hasAccess) router.replace("/dashboard");
    ...
    <div className={"space-y-8"}>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
          ...
          {!isMobileTiny && <Link href="/dashboard/orders" className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium">View all →</Link>}
        </div>
